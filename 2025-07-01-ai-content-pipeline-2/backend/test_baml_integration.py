...
def test_baml_summarize():
    ...
    if not openai_key and not anthropic_key:
        print(
            "❌ ERROR: No AI API keys found. Please set OPENAI_API_KEY or ANTHROPIC_API_KEY in your .env file"
        )
        return False
    ...
    try:
        ...
        summary: types.VideoSummary = b.SummarizeVideo(
            transcript=test_transcript, title="AI Content Pipeline Project Update"
        )
        ...
        email: types.EmailDraft = b.GenerateEmailDraft(
            summary=summary, video_title="AI Content Pipeline Project Update"
        )
        print("\n📧 Email Draft:")
